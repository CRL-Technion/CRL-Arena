    ...
    marker_sets=[MarkerSet(name="Obstacle1",
                 ...
                 MarkerSet(name="Rosie-2",
                           ...
                           positions=[Position(x=0.5951037406921387, y=0.5292147397994995, z=0.1886003613471985),
                                      Position(x=0.5110214591026306, y=0.5120184063911438, z=0.16515624523162842),
                                      Position(x=0.5278427600860596, y=0.5316101312637329, z=0.16333530843257904)]),
                 MarkerSet(name="Ruby-1",
                           type=MarkerSetType.Robot,
                           positions=[Position(x=-0.8884782195091248, y=1.529779863357544, z=0.16961832344532013),
                                      Position(x=-0.8893804550170898, y=1.5923441171646118, z=0.1441146433353424),
                                      Position(x=-0.7864573001861572, y=1.560068917274475, z=0.1453550159931183)]),
                 MarkerSet(name="all",
